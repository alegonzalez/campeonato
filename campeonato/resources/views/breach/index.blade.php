      ...
      <div class="card card_option col-md-3 offset-md-1 shadow-drop-2-bottom" >
        ...
        <div class="card-body col-md-12">
          ...
          <div class="offset-md-1">
            <a href="{{ route('breach/show',['id_championship' => $championship->id] ) }}" class="btn btn-outline-success setting_button btn-lg btn-block"><i class="fa fa-pencil" aria-hidden="true"></i> &nbsp;Ir</a>
          </div>
        </div>
      </div>
    @endforeach
